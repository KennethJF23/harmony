        ...
        >
          ...
          >
            <div className="flex items-center justify-center mb-4">
              ...
              >
                <div className="w-16 h-16 rounded-full flex items-center justify-center shadow-lg">
                  <img src="/braihharmonicslogo.jpg" alt="Brain Harmonics" className="w-16 h-16 rounded-full object-cover" />
                </div>
                <motion.div
            ...
            <p className="text-[var(--foreground)]/60 mt-2">
              Sign in to access your neural harmony experience
            </p>
          </motion.div>
          ...
          >
            ...
            {/* Role Description */}
            <motion.div
              className="mb-6 p-4 bg-[var(--background)]/30 rounded-xl border border-[var(--primary)]/10"
              key={userType}
            ...
            >
              {userType === 'user' ? (
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <p className="text-sm font-medium text-[var(--foreground)]">General User Access</p>
                    <p className="text-xs text-[var(--foreground)]/60 mt-1">
                      Access brain harmonic music, track your sessions, and submit wellness reports
                    </p>
                  </div>
                </div>
              ) : (
                <div className="flex items-start space-x-3">
                  <svg className="w-5 h-5 text-[var(--wave)] mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="flex items-center justify-between">
                <label className="flex items-center space-x-2 cursor-pointer">
                  <input
                    type="checkbox"
                    className="w-4 h-4 rounded border-[var(--primary)]/20 text-[var(--primary)] focus:ring-[var(--primary)]/20"
                  />
                  <span className="text-sm text-[var(--foreground)]/60">Remember me</span>
                </label>
                <Link
